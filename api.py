...
api.add_resource(Prediccion24h, '/servicio/v1/prediccion/24horas/')
api.add_resource(Prediccion48h, '/servicio/v1/prediccion/48horas/')
api.add_resource(Prediccion72h, '/servicio/v1/prediccion/72horas/')
